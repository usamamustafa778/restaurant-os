        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pb-4 border-t border-gray-100 mt-2 pt-4 space-y-3">
              {["features", "how-it-works", "pricing", "testimonials", "contact"].map(id => (
                <a key={id} href={`#${id}`} onClick={() => setMobileMenuOpen(false)} className="block text-sm text-gray-600 hover:text-primary capitalize">
                  {id.replace(/-/g, " ")}
                </a>
              ))}
              <Link href="/login" onClick={() => setMobileMenuOpen(false)} className="block text-sm font-medium text-gray-700">
                Sign in
              </Link>
            </div>
          )}
              ...
              <div className="relative">
                ...
                <div className="relative bg-white rounded-2xl border border-gray-200 shadow-2xl shadow-gray-200/50 p-6 space-y-4">
                  ...
                  <div className="flex items-end gap-1 h-12 px-2">
                    {[35, 50, 42, 60, 55, 72, 68, 80, 75, 90, 85, 95, 88, 70, 60, 50, 45, 55, 65, 78, 85, 92, 88, 75].map((h, i) => (
                      <div key={i} className="flex-1 rounded-t-sm bg-primary/20 hover:bg-primary/40 transition-colors" style={{ height: `${h}%` }} />
                    ))}
                  </div>
      ...
      <section className="bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-3xl md:text-4xl font-bold text-primary"><Counter end={500} suffix="+" /></p>
              <p className="text-sm text-gray-600 mt-1">Restaurants Onboarded</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-bold text-primary"><Counter end={50000} suffix="+" /></p>
              <p className="text-sm text-gray-600 mt-1">Orders Processed</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-bold text-primary"><Counter end={99} suffix="%" /></p>
              <p className="text-sm text-gray-600 mt-1">Uptime Reliability</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-bold text-primary"><Counter end={24} suffix="/7" /></p>
      ...
      <section id="features" className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                points: ["Instant order creation", "Discount & coupon support", "Auto-synced with your menu", "End-of-day sales reports"],
              },
              {
                icon: Package,
                ...
                points: ["Auto stock deduction", "Low-stock alerts", "Cost price tracking", "Units in kg, liter, piece"],
              },
              {
                icon: Globe2,
                ...
                points: ["Auto-generated on signup", "Live menu always in sync", "Online ordering ready", "Custom branding & colors"],
              },
            ].map((feature, i) => (
          ...
          <div className="grid gap-6 md:grid-cols-3 mt-8">
            {[
              { icon: BarChart3, title: "Daily Reports & Analytics", desc: "Revenue, profit, cost breakdown, and top-selling items — all in real-time dashboards." },
              { icon: Users, title: "Multi-Role Staff Access", desc: "Owner, admin, cashier, kitchen staff — each role sees only what they need." },
              { icon: ShoppingBag, title: "Online Orders", desc: "Accept orders directly from your website. Customers browse, order, and pay online." },
            ].map((f, i) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-sm">
                    <p className="text-3xl font-bold text-primary mb-1">10min</p>
      ...
      <section id="how-it-works" className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            {[
              { step: "01", title: "Create Your Account", desc: "Sign up, add your restaurant name and basic details. Your free website is generated instantly.", icon: ShoppingBag },
              { step: "02", title: "Set Up Your Menu", desc: "Add categories, items, prices and images. Link each dish to inventory ingredients.", icon: Utensils },
              { step: "03", title: "Start Taking Orders", desc: "Staff log in to POS, create orders and close bills. Inventory updates automatically.", icon: MonitorSmartphone },
              { step: "04", title: "Track & Grow", desc: "Review daily reports, monitor costs and profits. Make data-driven decisions.", icon: TrendingUp },
            ].map((item, i) => (
            ...
            {[
              ...
              <Reveal key={t.name} delay={i * 150}>
                <div className="h-full rounded-2xl bg-white border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed mb-6 flex-1">&ldquo;{t.text}&rdquo;</p>
                  ...
                  <ul className="space-y-3 mb-8 flex-1">
                    {plan.features.map(f => (
                      <li key={f} className="flex items-center gap-2 text-sm">
                        <CheckCircle2 className={`w-4 h-4 shrink-0 ${plan.popular ? "text-emerald-300" : "text-emerald-500"}`} />
                        {f}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">+92 333 1234567</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-primary/5 flex items-center justify-center text-primary shrink-0">
