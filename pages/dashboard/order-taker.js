        ...
        <div className="h-[100dvh] flex flex-col items-center justify-center bg-white dark:bg-black px-6">
          <div className="w-full max-w-xs text-center">
            ...
            <p className="text-3xl font-black text-gray-900 dark:text-white mb-8 tracking-tight">
              PKR {(orderPlaced.total ?? subtotal).toLocaleString()}
            </p>
            <button
  ...
  return (
    <>
      ...
      <div className="h-[100dvh] flex flex-col bg-gray-50 dark:bg-black text-gray-900 dark:text-white overflow-hidden">
                    ...
                    {filteredItems.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Add button overlay (when not in cart) */}
                          {qty === 0 && (
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
        ...
        {/* Menu: floating cart bar */}
        {step === STEPS.MENU && cartBadge > 0 && (
          <div className="fixed bottom-0 inset-x-0 z-20 ot-safe-bottom">
        ...
        {step === STEPS.CART && cart.length > 0 && (
          <div className="fixed bottom-0 inset-x-0 z-20 ot-safe-bottom">
            <div className="bg-white dark:bg-neutral-950 border-t border-gray-100 dark:border-neutral-900 px-4 pt-3 pb-4">
              {/* Order summary */}
