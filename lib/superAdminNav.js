...
export const SUPER_ADMIN_NAV_ITEMS = [
  ...
  { href: "/super/accounting", ownerOnly: true },
  { href: "/super/users", permission: "platform.restaurants.view" },
  { href: "/super/customers", permission: "platform.customers.view" },
  { href: "/super/roles", permission: "platform.roles.view" },
  { href: "/super/permissions", permission: "platform.permissions.view" },
  { href: "/super/leads", permission: "platform.leads.view" },
  { href: "/super/blog", permission: "platform.blog.view" },
  { href: "/super/seo", permission: "platform.seo.manage" },
  { href: "/super/whatsapp", permission: "platform.whatsapp.view" },
  { href: "/super/settings", permission: "platform.settings.view" },
  { href: "/super/audit", permission: "platform.audit.view" },
];

/** First super page the user can open; profile is the universal fallback. */
export function getFirstSuperAdminPath(canAccessItem) {
  for (const item of SUPER_ADMIN_NAV_ITEMS) {
    if (item.ownerOnly) {
      if (canAccessItem("*")) return item.href;
      continue;
    }
    if (item.permission && canAccessItem(item.permission)) {
      return item.href;
    }
  }
