...
export const KDS_FILTER_PRESETS = [
  { id: "all", label: "All orders", shortLabel: "All", description: "Every active ticket" },
  { id: "DINE_IN", label: "Dine in", shortLabel: "Dine in", description: "Table service only" },
  { id: "TAKEAWAY", label: "Takeaway", shortLabel: "Takeaway", description: "Pickup orders only" },
  { id: "DELIVERY", label: "Delivery", shortLabel: "Delivery", description: "Delivery orders only" },
  {
    id: "additions",
    label: "Additions",
    shortLabel: "Adds",
