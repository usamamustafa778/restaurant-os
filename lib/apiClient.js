...
/** Menu for rider portal (New Order) – uses rider-only endpoint so riders don't need admin access */
export async function getRiderMenu() {
  return apiFetch("/api/rider/menu");
}
