...
export async function createPosOrder({ items, orderType, paymentMethod, discountAmount, customerName, customerPhone, deliveryAddress, branchId, appliedDeals, tableName, amountReceived, paymentProvider }) {
