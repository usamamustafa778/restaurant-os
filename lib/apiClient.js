...
// POS – create a new order via backend (payment taken at counter; send PENDING)
export async function createPosOrder({ items, orderType, paymentMethod, discountAmount, customerName, customerPhone, deliveryAddress, branchId, appliedDeals, tableName }) {
  const payload = {
    items,
    orderType,
