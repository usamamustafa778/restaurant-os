...
export async function createPosOrder({ items, orderType, paymentMethod, discountAmount, customerName, customerPhone, deliveryAddress, deliveryLocationId, branchId, appliedDeals, tableName, amountReceived, paymentProvider }) {
