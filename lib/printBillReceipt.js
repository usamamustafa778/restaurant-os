...
import { formatReceiptItemsForBill } from "./orderDisplay.js";
    ...
    .map((it, index) => {
      ...
      return `<tr>
          <td style="padding:4px 0;${topBorder}border-bottom:1px dashed #000;white-space:normal;">
            ...
            ${dealBadge}
            ${!it.isDealLine && it.variantLabel ? `<div style="font-size:10px;color:#555;margin-top:1px;">(${escapeHtml(it.variantLabel)})</div>` : ""}
            ${eachHint}
          </td>
