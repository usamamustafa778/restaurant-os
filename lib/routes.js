...
//
// ROUTING MODEL:
//   Dashboard:           sufieats.com/dashboard/...   (no slug, tenant from JWT)
//   Restaurant website:  slug.sufieats.com            (subdomain)
...
export function buildTenantUrl(slug, path = "") {
  // Dashboard paths are always on the main domain (no slug prefix)
